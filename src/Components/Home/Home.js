...
const Home = (props) => {
  ...
  return (
    <div className="home">
      ...
      <p>"Sort of" and "close enough" are not good enough for me. So I reverse engineered some items, took measurements, built <i>proper</i> formulas, built some programs to do the calculations for me and then put them online for everyone to enjoy. Measurements are all displayed to the nearest 1/16th inch - because I don't know about you but I have a terrible time figuring out where 4.39 inches lands on a ruler.</p>
      <h2>Requirements</h2>
      <p>The gift bag does not require special tools but the other items require some sort of envelope <a href="http://www.wermemorykeepers.com/default.aspx?PageID=956&CategoryID=804&ProductID=15548&ItemID=17208&RootCatCode=08000" target="_blank" rel="noopener noreferrer">punch boards</a> or similar.</p>
